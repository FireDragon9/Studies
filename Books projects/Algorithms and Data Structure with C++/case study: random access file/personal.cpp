...
void Personal::writeToFile(fstream& out) const{
  ...
  //forces function write() to treat salary as a 4-byte-long string
  //by converting the address &salary to const car* and specifying the length of type long 
...
void Personal::readFromFile(fstream& in){
  ...
  //casts &salary to char* with the operator reinterpret_cast and specifies that 4 bytes should 
  //be read into long data member salary
